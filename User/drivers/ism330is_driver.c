...
/* Conditional printf for ISM330IS driver module */
#if (ENABLE_DRV_PRINTF && ENABLE_DRV_PRINTF_ISM330IS_DRIVER)
    #define ISM330IS_DRIVER_PRINTF(...)    printf(__VA_ARGS__)
#else
    #define ISM330IS_DRIVER_PRINTF(...)    ((void)0)
#endif
